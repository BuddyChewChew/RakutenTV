...
EPG_WINDOW_HOURS    = 72  # keep in lockstep with epg_duration_minutes below
...
def get_epg_window():
    ...
    end = now + timedelta(hours=EPG_WINDOW_HOURS)
    return now, end
...
def main():
    ...
    params = (
        ...
        f"&epg_duration_minutes={EPG_WINDOW_HOURS * 60}"
